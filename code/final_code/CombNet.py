...
class CombNet(nn.Module):
    ...
    def __init__(self, label_nbr=2):
        ...
        self.classifier = nn.Linear(32768, 128)
        #self.dropout = nn.Dropout(p=0.2)
        #self.rescale = torch.nn.Softmax()
        # Adding 2 layers for type prediction

        self.fc_comp1 = nn.Linear(128, 64)
        self.fc_comp2 = nn.Linear(64, 3)
        self.fc_echo1 = nn.Linear(128, 64)
        self.fc_echo2 = nn.Linear(64, 4)
        self.fc_margin1 = nn.Linear(128, 64)
        self.fc_margin2 = nn.Linear(64, 3)
        self.fc_calc1 = nn.Linear(128, 64)
        self.fc_calc2 = nn.Linear(64, 4)
